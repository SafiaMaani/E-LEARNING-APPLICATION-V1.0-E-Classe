<?php
    if (isset($_POST['sign_in'])) 
    {
       ...
       $password = $_POST['userPassword'];
        ...
        if($email == 'safia@gmail.com' && $password == 123)
        {
        ...
        <main class="bg-white px-4">
            ...
            <form method="post" action="index.php">
                <div class="mb-3 ">
                    ...
                    <input type="email" name="userEmail" placeholder="Enter your email" class="form-control shadow-none" id="exampleInputEmail1" aria-describedby="emailHelp">
                </div>
                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label text-muted">Password</label>
                    <input type="password" name="userPassword" placeholder="Enter your password" class="form-control shadow-none" id="exampleInputPassword1">
                </div>
